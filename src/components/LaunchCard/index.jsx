...
import { DisplayModal } from "../DisplayModal/index";
    ...
    <>
      <section className={`${LaunchCardStyle.launch__card} card`}>
        ...
        <div className="row w-100 mx-0">
          ...
          >
            {props.launchDetails.links.flickr_images.length >= 1 ? (
              <img
                src={
              ...
              <div className={LaunchCardStyle.no__img}>No image record</div>
            )}
          </div>
          ...
          <div className={`${LaunchCardStyle.name__details} col-lg-2 col-4`}>
          ...
          >
            <div className={LaunchCardStyle.learn__more__link}>
              <a onClick={() => handleLearnMore(props?.launchDetails)}>
                Learn more
              </a>
            </div>
          </div>
